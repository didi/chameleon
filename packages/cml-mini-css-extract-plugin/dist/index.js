...
const cmlHelper = require('./helper');
...
class MiniCssExtractPlugin {
    ...
    compiler.hooks.thisCompilation.tap(pluginName, compilation => {
      ...
      compilation.mainTemplate.hooks.renderManifest.tap(pluginName, (result, {
        ...
        if (renderedModules.length > 0) {
          result.push({
            render: () => this.renderContentAsset(compilation, chunk, renderedModules, compilation.runtimeTemplate.requestShortener, compiler),
  ...
  renderContentAsset(compilation, chunk, modules, requestShortener, compiler) {
    ...
    usedModules = cmlHelper.sortChunk(usedModules, allFileSort);
